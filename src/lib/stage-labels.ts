...
export const STAGE_LABEL_SHORT: Record<string, string> = {
  ...
  assessment_en_progreso: 'Elevare en curso',
...
export const STAGE_LABEL_LONG: Record<string, string> = {
  ...
  assessment_invitado: 'Invitado a Elevare',
  assessment_en_progreso: 'Tomando Elevare',
  assessment_completado: 'Elevare completado',
...
export const STAGE_ACTION: Record<string, string> = {
  ...
  assessment_completado: 'Agendar entrevista con reclutador',
