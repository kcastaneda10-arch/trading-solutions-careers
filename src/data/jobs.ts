...
The Role: You will develop pricing strategies, manage rates with carriers and agents, and turn market insight into profitable business between Asia and Latin America.`,
  ...
  {
    id: 12,
    slug: "especialista-sig-sst",
    linkedinUrl: "",
    title: {
      es: "Especialista SIG-SST",
      en: "Integrated Management Systems & HSE Specialist",
    },
    dept: "Wellness",
    location: "Barranquilla, Atl\u00e1ntico, Colombia",
    mode: "Presencial",
    level: "Senior",
    salary: "A convenir",
    tags: ["SIG", "SST", "BASC V6", "ISO 9001/14001/45001", "Licencia SST", "Biling\u00fce EN/ES"],
    description: {
      es: "Trading Solutions es una compa\u00f1\u00eda de log\u00edstica internacional. Movemos carga entre continentes bajo cinco sistemas de gesti\u00f3n que se auditan de verdad: calidad, ambiental, seguridad y salud en el trabajo, seguridad de la cadena de suministro e inocuidad.\n\nBuscamos un Especialista SIG-SST que sea due\u00f1o de ese sistema completo, no de una parte. No buscamos a alguien que llene formatos antes de la auditor\u00eda: buscamos criterio normativo, rigor documental y presencia en terreno.",
      en: "Trading Solutions is an international logistics company. We move cargo across continents under five management systems that get audited for real: quality, environment, occupational health and safety, supply chain security and food safety.\n\nWe are hiring an Integrated Management Systems & HSE Specialist to own that system end to end, not one piece of it. We are not looking for someone to fill in forms before the audit: we are looking for regulatory judgment, documentary rigour and presence on the ground.",
    },
    responsibilities: {
      es: [
        ...
        "Liderar al Analista SIG y al practicante, y llevar el sistema a bodega, patio y puerto \u2014 no solo al escritorio",
      ],
      en: [
        ...
        "Lead the SIG Analyst and the intern, and take the system to the warehouse, the yard and the port \u2014 not just to the desk",
      ],
    },
    requirements: {
      es: [
        ...
        "Preferible: experiencia en log\u00edstica internacional, freight forwarding, agenciamiento aduanero, puerto o zona franca",
      ],
      en: [
        ...
        "Preferred: background in international logistics, freight forwarding, customs brokerage, ports or free trade zones",
      ],
    },
    applyEmail: "jointheteam@tradingsolutions.com",
    postedAt: "2026-09-07",
