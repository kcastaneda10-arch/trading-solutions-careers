...
The Role: You will develop pricing strategies, manage rates with carriers and agents, and turn market insight into profitable business between Asia and Latin America.`,
  ...
  },
  {
    ...
    level: "Mid-Level",
    salary: "A convenir",
    tags: ["Seleccion", "Psicometria", "Entrevista por competencias", "ATS", "Bilingue EN/ES"],
    description: {
      es: "Trading Solutions es una compania de logistica internacional. Movemos carga entre continentes y, para sostener ese crecimiento, necesitamos elegir bien a las personas que lo hacen posible.\n\nBuscamos un Talent Acquisition Specialist: un profesional en Psicologia que lidere nuestros procesos de seleccion de punta a punta y que evalue con rigor tecnico. No buscamos a alguien que coordine agendas: buscamos criterio.",
    ...
    responsibilities: {
      es: [
        "Levantar el perfil con el lider solicitante antes de publicar y definir la estrategia de busqueda de cada vacante",
        "Ejecutar sourcing activo y headhunting en LinkedIn, portales de empleo, bases propias, referidos y alianzas academicas",
        "Conducir entrevistas por competencias (metodologia STAR/BEI) en espanol e ingles",
        "Aplicar, calificar e interpretar la bateria psicometrica corporativa y elaborar informes de evaluacion dirigidos al lider de negocio",
        "Construir y sustentar la terna de finalistas con evidencia y una recomendacion tecnica",
        "Verificar referencias y coordinar los pasos de la etapa de contratacion con el equipo de People Ops",
        "Mantener la trazabilidad del proceso en el ATS y reportar los indicadores de seleccion",
      ],
      en: [
    ...
    requirements: {
      es: [
        "Profesional en Psicologia con tarjeta profesional vigente",
        "De 2 a 4 anos de experiencia en seleccion de punta a punta, con responsabilidad directa sobre vacantes",
        "Minimo 1 ano aplicando e interpretando pruebas psicometricas y elaborando informes de evaluacion",
        "Ingles B2 o superior. Se valida durante el proceso con entrevista en vivo y prueba escrita",
        "Formacion o certificacion en entrevista por competencias (BEI/STAR)",
        "Excel nivel intermedio-avanzado y manejo de plataformas ATS",
        "Preferible: experiencia en logistica internacional, freight forwarding, comercio exterior, agenciamiento aduanero o navieras",
        "Preferible: experiencia en companias con operacion en varios paises y equipos distribuidos",
      ],
      en: [
